  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php if ($level == 'rt') : ?>
          <li class="nav-item">
            <a href="<?php echo base_url('rt/index') ?>" class="nav-link <?php echo ($_SERVER['REQUEST_URI'] == '/dashboard' ? "active" : ""); ?>">
              <i class="nav-icon fas fa-th text-light"></i>
              <p class="text-light">Dashboard</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url('rt/daftarSurat') ?>" class="nav-link <?php echo ($_SERVER['REQUEST_URI'] == '/daftar-surat' ? "active" : ""); ?>">
        ...
        <?php if ($level == 'warga') : ?>
          <li class="nav-item">
            <a href="<?php echo base_url('warga/index') ?>" class="nav-link <?php echo ($_SERVER['REQUEST_URI'] == '/dashboard' ? "active" : ""); ?>">
              <i class="nav-icon fas fa-th text-light"></i>
              <p class="text-light">Dashboard</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url('warga/persyaratan') ?>" class="nav-link <?php echo ($_SERVER['REQUEST_URI'] == '/persyaratan' ? "active" : ""); ?>">
              <i class="nav-icon fas fa-file-alt text-light"></i>
